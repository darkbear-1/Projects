         ...
         <h1 class="blanki-title">Бланки документов</h1>
          ...
          <div class="stati__description">
            <div class="blanki__razdels">
              <div class="blanki__razdel-title"><?php echo $postMeta->name ?></div>
              <div class="blanki__razdels-container">
                <?php get_template_part( 'template-parts/loop-blanki', 'blanki', array('taxIds' => array($postMeta->term_id), 'termCheck' => is_tax('razdel_blanki')) ) ?>
              </div>
