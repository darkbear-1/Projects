  ...
  <div class="container">
   ...
   <?php if (!empty($siteSettings['brendirovanie_variants']) && $siteSettings['brendirovanie_variants_checker'] == 'true'): ?>
    ...
    <?php do_action('content_inner'); ?>
      <h1 class="stati__title"><?php echo get_the_archive_title();?></h1>
...
<path opacity="0.2" fill-rule="evenodd" clip-rule="evenodd" d="M2.78617 11.4312L7.73081 2.22865C7.90065 1.91256 7.90065 1.54275 7.73081 1.22666C7.27323 0.375048 5.9406 0.375048 5.48301 1.22666L0 11.4312L5.48301 21.6357C5.9406 22.4873 7.27323 22.4873 7.73081 21.6357C7.90065 21.3197 7.90065 20.9498 7.73081 20.6338L2.78617 11.4312Z" fill="#54BCE3"/>
        ...
        <?php if (!is_paged()): ?>
          <?php while( have_posts() ) :?>
            ...
            <?php endif; ?>
            <?php if ($i == 2 && $siteSettings['adventages_stati_archive_checker'] == 'true' ) : ?>
              <div class="advertising advertising-mobile">
                <div class="advertising__wrap">
                  <a target="_blank" href="<?php echo $siteSettings['adventages_stati_archive_link']?>">
                    <?php echo wp_get_attachment_image($siteSettings['adventages_stati_archive_mobile'], 'full') ?>
                  </a>
                </div>
              </div>
            <?php endif ?>
        ...
        <?php endif; ?>
                  <div class="stati__item stati__item--rubriki">
                    ...
                    <?php endforeach; ?>
                    <!--<a href="/stati/" class="stati__rubriki-all">Все рубрики</a>-->
                  </div>
                  <?php if (is_paged()): ?>
                    <?php while( have_posts()) :?>
                      <?php the_post();?>
                      <div class="more__wrap more__wrap--pagination">
