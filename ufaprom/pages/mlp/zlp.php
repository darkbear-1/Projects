            ...
            <div class="mlp__screen-wrap col-flex-row">
              <div class="mlp__screen-row col-flex-row">
                <div class="mlp__screen-image">
                  <?php echo do_shortcode('[IMG id=13 fallback="zlp.jpg"]') ?>
                </div>
                <div class="mlp__screen-info_wrap">
                  <ul class="mlp__screen-list">
                    ...
                    <?php if (!empty(do_shortcode('[UTP3 id=7 fallback="Аренда на выгодных условиях"]'))): ?>
                      <li class="mlp__screen-list_item">
                        <?php echo do_shortcode('[UTP3 id=7 fallback="Аренда на выгодных условиях"]') ?>
                      </li>
                    <?php endif; ?>
                    <li class="mlp__screen-list_item">
                      <?php echo do_shortcode('[UTP4 id=8 fallback="Возможность продать люльку обратно за 70% от стоимости"]') ?>
                    </li>
                    <li class="mlp__screen-list_item">
                      <?php echo do_shortcode('[UTP5 id=9 fallback="Буферные колеса для защиты фасада от повреждений"]') ?>
                    </li>
                  </ul>
                </div>
              </div>
...
<path d="M27.4167 5.66665C31.9033 5.66665 36.2061 7.44893 39.3786 10.6214C42.5511 13.7939 44.3333 18.0967 44.3333 22.5833C44.3333 23.2243 44.588 23.8389 45.0412 24.2922C45.4944 24.7454 46.1091 25 46.75 25C47.391 25 48.0056 24.7454 48.4589 24.2922C48.9121 23.8389 49.1667 23.2243 49.1667 22.5833C49.1667 16.8149 46.8752 11.2827 42.7962 7.20374C38.7173 3.12482 33.1851 0.833313 27.4167 0.833313C26.7757 0.833313 26.161 1.08793 25.7078 1.54114C25.2546 1.99435 25 2.60904 25 3.24998C25 3.89092 25.2546 4.50561 25.7078 4.95882C26.161 5.41203 26.7757 5.66665 27.4167 5.66665ZM48.5625 34.4491C48.4296 34.0612 48.2001 33.7134 47.8957 33.4386C47.5913 33.1638 47.222 32.971 46.8225 32.8783L32.3225 29.5675C31.9289 29.4782 31.5193 29.489 31.1309 29.5987C30.7425 29.7085 30.3878 29.9138 30.0992 30.1958C29.7608 30.51 29.7367 30.5341 28.1658 33.5308C22.9536 31.129 18.7771 26.9354 16.3967 21.7133C19.4658 20.1666 19.49 20.1666 19.8042 19.8041C20.0862 19.5155 20.2915 19.1608 20.4012 18.7724C20.511 18.3841 20.5218 17.9744 20.4325 17.5808L17.1217 3.24998C17.029 2.85049 16.8362 2.48117 16.5614 2.17677C16.2866 1.87236 15.9388 1.6429 15.5508 1.50998C14.9865 1.3084 14.4037 1.16271 13.8108 1.07498C13.2 0.933351 12.5767 0.852403 11.95 0.833313C9.00169 0.833313 6.17412 2.00453 4.08934 4.08931C2.00456 6.17409 0.833344 9.00166 0.833344 11.95C0.846132 21.8165 4.77127 31.2753 11.748 38.252C18.7247 45.2287 28.1835 49.1539 38.05 49.1666C39.5099 49.1666 40.9554 48.8791 42.3042 48.3204C43.6529 47.7618 44.8784 46.9429 45.9107 45.9107C46.943 44.8784 47.7618 43.6529 48.3205 42.3041C48.8791 40.9554 49.1667 39.5098 49.1667 38.05C49.1674 37.4349 49.1189 36.8207 49.0217 36.2133C48.9
.9131 15.1586 34.8414C9.08694 28.7697 5.67308 20.5366 5.66668 11.95C5.67304 10.2855 6.33708 8.691 7.51406 7.51402C8.69103 6.33705 10.2855 5.67301 11.95 5.66665H12.7475L15.3333 16.88L14.0283 17.5566C11.95 18.6441 10.3067 19.5141 11.1767 21.3991C12.5934 25.4098 14.8857 29.0545 17.8871 32.0684C20.8885 35.0824 24.5236 37.3899 28.5283 38.8233C30.5583 39.645 31.3558 38.1225 32.4433 36.02L33.1442 34.6908L44.3333 37.2525V38.05C44.327 39.7145 43.6629 41.309 42.486 42.4859C41.309 43.6629 39.7145 44.327 38.05 44.3333Z" fill="#FF8D24"/>
        ...
        <div class="mlp-info">
          <div class="container">
            <h2 class="mlp-info__title">Почему более 500 покупателей заказали люльки ZLP 630 у нас?</h2>
            <div class="mlp-info__subtitle">Мы перепробовали многие виды подъемников, и ZLP — лучший выбор по соотношению цены/качества и надежности.</div>
            <div class="mlp-info__advantages">
              <div class="mlp-info__advantages-row col-flex-row">
                <div class="mlp-info__advantages-col col-w_2">
                  <div class="projects-sinlge__slider-list  projects-sinlge__slider-list--advantages owl-carousel">
                        <div class="projects-sinlge__slider-image"><img class="projects-sinlge__slider-img owl-lazy" data-src="/wp-content/uploads/2020/12/mainscreen-1.png" alt=""></div>
                        <div class="projects-sinlge__slider-image"><img class="projects-sinlge__slider-img owl-lazy" data-src="/wp-content/uploads/2020/12/close-up-1.png" alt=""></div>
                        <div class="projects-sinlge__slider-image"><img class="projects-sinlge__slider-img owl-lazy" data-src="/wp-content/uploads/2020/12/close-up-2.png" alt=""></div>
                        <div class="projects-sinlge__slider-image"><img class="projects-sinlge__slider-img owl-lazy" data-src="/wp-content/uploads/2020/12/close-up-6.png" alt=""></div>
                        <div class="projects-sinlge__slider-image"><img class="projects-sinlge__slider-img owl-lazy" data-src="/wp-content/uploads/2020/12/close-up-5-1.png" alt=""></div>
                        <div class="projects-sinlge__slider-image"><img class="projects-sinlge__slider-img owl-lazy" data-src="/wp-content/uploads/2020/12/mainscreen-3.png" alt=""></div>
                        <div class="projects-sinlge__slider-image"><img class="projects-sinlge__slider-img owl-lazy" data-src="/wp-content/uploads/2020/12/close-up-4.png" alt=""></div>
                        <div class="projects-sinlge__slider-image"><img class="projects-sinlge__slider-img owl-lazy" data-src="/wp-content/uploads/2020/12/close-up-3.png" alt=""></div>
                        <div class="projects-sinlge__slider-image"><img class="projects-sinlge__slider-img owl-lazy" data-src="/wp-content/uploads/2020/12/mainscreen-2.png" alt=""></div>
          				</div>
                </div>
                <div class="mlp-info__advantages-col col-w_2">
                  <ul class="mlp-info__advantages-list">
                    <li class="mlp-info__advantages-item">
                      <i class="fa fa-check"></i>
                      <span>Все подъемники сертифицированы в Ростехнадзоре и прошли испытания на безопасность</span>
                    </li>
                    <li class="mlp-info__advantages-item">
                      <i class="fa fa-check"></i>
                      <span>Наш профессиональный инженер обучит ИТРов и монтажников</span>
                    </li>
                    <li class="mlp-info__advantages-item">
                      <i class="fa fa-check"></i>
                      <span>Работаем по официальному договору и несем полную ответственность</span>
                    </li>
                    <li class="mlp-info__advantages-item">
                      <i class="fa fa-check"></i>
                      <span>Мы поставляем люльки напрямую с заводами BOYU и Haoke</span>
                    </li>
                    <li class="mlp-info__advantages-item">
                      <i class="fa fa-check"></i>
                      <span>Бесплатная доставка до объекта в срок и без задержек</span>
                    </li>
                    <li class="mlp-info__advantages-item">
                      <i class="fa fa-check"></i>
                      <span>Выгоднее, чем леса и вышки-туры при сложных фасадах</span>
                    </li>
                    <li class="mlp-info__advantages-item">
                      <i class="fa fa-check"></i>
                      <span>Счет и договор — в день обращения. Доставка, подъем и монтаж — на следующий день</span>
                    </li>
                    <li class="mlp-info__advantages-item">
                      <i class="fa fa-check"></i>
                      <span>Быстрый монтаж лебедок</span>
                    </li>
                  </ul>
                </div>
              </div>
            </div>
            <h2 class="mlp-info__title">Наши ZLP-630 в деле</h2>
            <div class="projects-single__video-container projects-single__video-container--zlp">
  					<img src="/wp-content/uploads/2020/12/zlp_video.jpg" alt="" class="projects-single__video-bg">
    					<div class="about__btn about__btn--projects" data-video-id="VhLf7_peuqY">
  ...
  <path d="M27.4167 5.66665C31.9033 5.66665 36.2061 7.44893 39.3786 10.6214C42.5511 13.7939 44.3333 18.0967 44.3333 22.5833C44.3333 23.2243 44.588 23.8389 45.0412 24.2922C45.4944 24.7454 46.1091 25 46.75 25C47.391 25 48.0056 24.7454 48.4589 24.2922C48.9121 23.8389 49.1667 23.2243 49.1667 22.5833C49.1667 16.8149 46.8752 11.2827 42.7962 7.20374C38.7173 3.12482 33.1851 0.833313 27.4167 0.833313C26.7757 0.833313 26.161 1.08793 25.7078 1.54114C25.2546 1.99435 25 2.60904 25 3.24998C25 3.89092 25.2546 4.50561 25.7078 4.95882C26.161 5.41203 26.7757 5.66665 27.4167 5.66665ZM48.5625 34.4491C48.4296 34.0612 48.2001 33.7134 47.8957 33.4386C47.5913 33.1638 47.222 32.971 46.8225 32.8783L32.3225 29.5675C31.9289 29.4782 31.5193 29.489 31.1309 29.5987C30.7425 29.7085 30.3878 29.9138 30.0992 30.1958C29.7608 30.51 29.7367 30.5341 28.1658 33.5308C22.9536 31.129 18.7771 26.9354 16.3967 21.7133C19.4658 20.1666 19.49 20.1666 19.8042 19.8041C20.0862 19.5155 20.2915 19.1608 20.4012 18.7724C20.511 18.3841 20.5218 17.9744 20.4325 17.5808L17.1217 3.24998C17.029 2.85049 16.8362 2.48117 16.5614 2.17677C16.2866 1.87236 15.9388 1.6429 15.5508 1.50998C14.9865 1.3084 14.4037 1.16271 13.8108 1.07498C13.2 0.933351 12.5767 0.852403 11.95 0.833313C9.00169 0.833313 6.17412 2.00453 4.08934 4.08931C2.00456 6.17409 0.833344 9.00166 0.833344 11.95C0.846132 21.8165 4.77127 31.2753 11.748 38.252C18.7247 45.2287 28.1835 49.1539 38.05 49.1666C39.5099 49.1666 40.9554 48.8791 42.3042 48.3204C43.6529 47.7618 44.8784 46.9429 45.9107 45.9107C46.943 44.8784 47.7618 43.6529 48.3205 42.3041C48.8791 40.9554 49.1667 39.5098 49.1667 38.05C49.1674 37.4349 49.1189 36.8207 49.0217 36.2133C48.9201 35.613 48.7665 35.0228 48.5625 34.4491ZM38.05 44.3333C29.4634 44.3269 21.2303 40.9131 15.1586 34.8414C9.08694 28.7697 5.67308 20.5366 5.66668 11.95C5.67304 10.2855 6.33708 8.691 7.51406 7.51402C8.69103 6.33705 10.2855 5.67301 11.95 5.66665H12.7475L15.3333 16.88L14.0283 17.5566C11.95 18.6441 10.3067 19.5141 11.1767 21.3991C12.5934 25.4098 14.8857 29.0545 17.8871 32.0684C20.8885 35.0824 24.5236 37.3899 28.5283 38.8233C30.5583 39.645 31.3558 38.1225 32.4433 36.02L33.1442 34.6908L44.3333 37.2525V38.05C44.327 39.7145 43.6629 41.309 42.486 42.4859C41.309 43.6629 39.7145 44.327 38.05 44.3333Z" fill="#FF8D24"/>
        ...
        <div class="mlp-econom mlp-econom--zlp">
          <div class="container">
            <h2 class="mlp-econom__title mlp-info__title">ХОТИТЕ СЭКОНОМИТЬ? МЫ ПОМОЖЕМ!​</h2>
            <div class="mlp-econom__subtitle">Покупка подъемника ZLP 630 в собственность хорошо подойдет средним и большим предприятиям по обустройству фасадов. Если вам нужно несколько подъемников на небольшой срок, или у вас маленькая компания, то рекомендуем рассмотреть варианты — аренда или покупка Б/У.</div>
            <div class="mlp-econom__variants col-grid-3 pad-t-40">
              <div class="mlp-econom__variants-new">
                <div class="mlp-econom__variants-title">Покупка новой</div>
                <div class="mlp-econom__variants-wrap">
                  <div class="mlp-econom__variants-image">
                    <img src="/wp-content/uploads/2020/12/zlp1-1.jpg" alt="">
                  </div>
              ...
              <div class="mlp-econom__variants-new">
                <div class="mlp-econom__variants-title">Покупка Б/У</div>
                <div class="mlp-econom__variants-wrap">
                  <div class="mlp-econom__variants-image">
                    <img src="/wp-content/uploads/2020/12/zlp2.jpg" alt="">
                  </div>
                  <ul class="mlp-econom__variants-list">
                    <li class="mlp-econom__variants-item">- Дешевле на 15-20%</li>
                    <li class="mlp-econom__variants-item">- Ничем не уступает новой по функционалу и надежности</li>
              ...
              <div class="mlp-econom__variants-bu">
                <div class="mlp-econom__variants-title">Аренда</div>
                <div class="mlp-econom__variants-wrap">
                  <div class="mlp-econom__variants-image">
                    <img src="/wp-content/uploads/2020/12/zlp3.jpg" alt="">
                  </div>
                  <ul class="mlp-econom__variants-list">
                    <li class="mlp-econom__variants-item">- Всего 660 рублей в сутки</li>
                    <li class="mlp-econom__variants-item">- На любой срок</li>
                    <li class="mlp-econom__variants-item">- Доставка до объекта эксплуатации</li>
                    <li class="mlp-econom__variants-item">- Уточняйте наличие по телефону</li>
                  </ul>
                </div>
              </div>
              <div class="mlp-econom__new-raschet mlp-econom__new-raschet--zlp">
